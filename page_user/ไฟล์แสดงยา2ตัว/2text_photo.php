    ...
    try {
        if ($slot === 'slot1') {
            ...
            if ($user['medicine_alert_time'] || $user['ocr_scans_text']) {
                echo json_encode(['status' => 'error', 'message' => 'Slot1 มีข้อมูลอยู่แล้ว']);
                exit();
            }
            ...
            if ($user['medicine_alert_time2'] || $user['ocr_scans_text2']) {
                echo json_encode(['status' => 'error', 'message' => 'Slot2 มีข้อมูลอยู่แล้ว']);
                exit();
            }
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label for="slotSelect">เลือก Slot:</label>
...
document.addEventListener("DOMContentLoaded", function() {
    $('#startOcrButton').click(function() {
        ...
        $.ajax({
            url: '', // Set to the path of your PHP file for OCR processing
            method: 'POST',
            data: formData,
            contentType: false,
            processData: false,
